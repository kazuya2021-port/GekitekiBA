...
@protocol DistillerGenericMethods
...
- (BOOL) DistillSourcePath:(NSString *)sourcePath adobePDFSettingsPath:(NSString *)adobePDFSettingsPath destinationPath:(NSString *)destinationPath;  // Distill a file.
...
// A scriptable object.
@interface DistillerItem : SBObject <DistillerGenericMethods>
...
- (SBElementArray<DistillerDocument *> *) documents;
- (SBElementArray<DistillerWindow *> *) windows;
...
- (SBElementArray<DistillerAttachment *> *) attachments;
- (SBElementArray<DistillerAttributeRun *> *) attributeRuns;
- (SBElementArray<DistillerCharacter *> *) characters;
- (SBElementArray<DistillerParagraph *> *) paragraphs;
- (SBElementArray<DistillerWord *> *) words;
...
@interface DistillerPrintSettings : SBObject <DistillerGenericMethods>
